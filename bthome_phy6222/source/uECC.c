...
int main() {
    struct AES_ctx ctx;
    // Esempio di utilizzo
    //672244123691036157795385674671986808757733834286
    //0x75c078146e4456347d3916338b739972f3543e2e
    uint8_t r[32]={0};
    
        uint8_t google_findmy_key[]={
            0x6b,0xf1,0x14,0xda,0x69,0x1c,0x5a,0x5b,0xe8,0x7d,0x24,0x0a,0x40,0x67,0xd4,0x7a,
            0x95,0xcb,0x8f,0xdf,0x28,0x9f,0x06,0x95,0x8d,0x11,0x66,0xc6,0xd8,0x13,0x5b,0xa4
        };
        ...
        AES_init_ctx(&ctx,google_findmy_key);
        ...
        uECC_vli_mmod(r,data1,curve->n,32);
        ...
        EccPoint_compute_public_key(r,data1,curve);
        for (size_t i = 0; i < 20; i++)
        {
            printf("%02x",r[19-i]);
        }
